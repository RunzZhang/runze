...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self, parent=None):
        ...
        self.IDHTR1004 = PnID_Alone(self.TubeTab)
        self.IDHTR1004.Label.setText("Heater 5")
        self.IDHTR1004.move(1317 * R, 1020 * R)
