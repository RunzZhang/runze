...
class UpdatePLC(QtCore.QObject):
    ...
    def or_alarm_signal(self):
        if  (True in self.PLC.PT_Alarm) or (True in self.PLC.TT_AD1_Alarm) or(True in self.PLC.TT_AD2_Alarm) or (True in self.PLC.LEFT_REAL_Alarm) or (True in self.PLC.Din_Alarm) or (True in self.PLC.LOOPPID_Alarm):
...
class UpdateServer(QtCore.QObject):
    def __init__(self, PLC, parent=None):
        ...
        # self.TT_AD_dic_ini = copy.copy(sec.TT_AD_DIC)
        # self.PT_dic_ini = copy.copy(sec.PT_DIC)
        # self.LEFT_REAL_ini = copy.copy(sec.LEFT_REAL_DIC)
        # self.TT_AD_LowLimit_ini = copy.copy(sec.TT_AD_LOWLIMIT)
        # self.TT_AD_HighLimit_ini = copy.copy(sec.TT_AD_HIGHLIMIT)
        ...
        # self.TT_AD_Activated_ini = copy.copy(sec.TT_AD_ACTIVATED)
        # self.PT_Activated_ini = copy.copy(sec.PT_ACTIVATED)
        # self.TT_AD_Alarm_ini = copy.copy(sec.TT_AD_ALARM)
